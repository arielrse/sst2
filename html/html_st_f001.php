...
p8,
p9,
obs,nro_ticket,id_nodo,fecha_apertura,fecha_cierre,
conclusiones,
fecha_registro,
condicion_final,
postm_fecha,
...
<tr>
<td width="60%">Raz�n de la visita:
  <b><?=$dato['detalles'];?></b></td>
<td width="40%">Fecha Actual:<b>
  <?=$fecha;?>
</b></td>
</tr>
<tr>
...
<tr>
<td>Nro. de Ticket:</td>
<td><span class="azul"><?=$dato_tkt['ticket'].'  |  NOD:'.$dato_tkt['idnodo'];?></span></td>
</tr>
<tr>
<td width="25%">Fecha de Apertura:</td>
<td><span class="azul"><?=$dato_tkt['fecha_inicio_rif'].' - '.$dato_tkt['hora_inicio_rif'];?></span> </td>
</tr>
<tr>
<td width="25%">Fecha de Cierre:</td>
<td><span class="azul"><?=$dato_tkt['fecha_fin_rif'].' - '.$dato_tkt['hora_fin_rif'];?></span> </td>
</tr>
</table>
...
<!--
<tr>
<th colspan="2">DA�OS Y PARTES AFECTADAS EN LA ESTACI�N</th>
</tr>
<tr>
<td colspan="2" >
<?=nl2br($dato['p71'])?></td>
