...
<br />
<TABLE class="table2" width="900" align="center">
		<tr> <!-- Filas -->
	...
	<tr>
	  	...
	  	<td width="75%"><input name="p02" type="text" id="p02" size="20" /></td>
	</tr>
	<tr>
	  	<th width="25%">Apellido Materno</th>
	  	<td width="75%"><input name="p03" type="text" id="p03" size="20" /></td>
	</tr>
	<tr>
	  	<th width="25%">Nombres</th>
		<td width="75%"><input name="p04" type="text" id="p04" size="20" /></td>
	</tr>


	<tr>
	  	<th width="25%">Tel. Celular</th>
		<td width="75%"><input name="p05" type="text" id="p05" size="20" /></td>
	</tr>

	<tr>
	  	<th width="25%">Tel. Celular (ALTERNATIVO)</th>
		<td width="75%"><input name="p13" type="text" id="p13" size="20" /></td>
	</tr>

	<tr>
	  	<th width="25%">Tel. Fijo</th>
		<td width="75%"><input name="p06" type="text" id="p06" size="20" /></td>
	</tr>
	...
	<tr>
		<th width="25%">Apellido Paterno</th>
		<td width="75%"><input name="p08" type="text" id="p08" size="20" /></td>
	</tr>
	<tr>
		<th width="25%">Apellido Materno</th>
		<td width="75%"><input name="p09" type="text" id="p09" size="20" /></td>
	</tr>
	<tr>
		<th width="25%">Nombres</th>
		<td width="75%"><input name="p10" type="text" id="p10" size="20" /></td>
	</tr>
	<tr>
		<th width="25%">Tel. Celular</th>
		<td width="75%"><input name="p11" type="text" id="p11" size="20" /></td>
	</tr>


	<tr>
	  	<th width="25%">Tel. Celular (ALTERNATIVO)</th>
		<td width="75%"><input name="p14" type="text" id="p14" size="20" /></td>
	</tr>

	<tr>
		<th width="25%">Tel. Fijo</th>
		<td width="75%"><input name="p12" type="text" id="p12" size="20" /></td>
	</tr>

</TABLE>
<br />
<TABLE width="900" align="center" class="table2">
    	<tr><th colspan="2"><strong class="verde">Otras observaciones</strong></th></tr>
