...
<table width="900" align="center" class="table2">
	...
	<tr>
		...
		<td width="75%"><? echo $nomEs . "&nbsp;&nbsp;&nbsp;&nbsp;<span class='cafe'><b>ID Estaci�n:</b></span> " . $codEs ?></td>
	</tr>
	...
	<tr>
	  <th width="25%">Tipo de estaci�n</th>
	  <td width="75%">
		  <select name="p02">
...
<table  width="1050" align="center" class="table2">
	...
	$text =	"Observar, registrar e informar el estado de los Caminos de Acceso;;;|".
	         "Observar, registrar e informar el estado de la infraestructura de la Estaci�n;;;";
	$arrays = explode('|',$text);
	$result = "";
	$a = 1;
	foreach ($arrays as $array){
...
<table  width="1050" align="center" class="table2">
		...
		<?
		$text =
				 "Limpieza de chasis, cubierta de grupos generadores, manchas de aceite, cables de interconexi�n;;;|".
	             "Limpieza de la Bater�a de arranque  y sus terminales;;;|".
	             "Limpieza del banco de bater�as, sus terminales y cables de interconexi�n;;;|".
	             "Limpieza de la superficie de cada  panel del arreglo solar;;;|".
	             "Limpieza de  las salas de  rectificadores y bater�as;;;|".
	             "Limpieza de las salas de grupos generadores;;;|".
	             "Limpieza y ordenamiento de las salas de grupo generador;;;|".
	             "Limpieza de  escalerillas y ductos de cables de energ�a;;;|".
	             "Limpieza del �rea  dentro y fuera del cerco  perimetral del material residual de desechos s�lidos (Incluye papel pegado en la pared) y l�quidos;;;|".
	             "Retiro de maleza en el �rea interna y externa (4m circundantes) del sitio;;;";
		$arrays = explode('|',$text);
		$result = "";
		$a = 1;
		foreach ($arrays as $array){
...
<table  width="1050" align="center" class="table2">
		...
		<?
		$text =
				 "Verificaci�n de filtraci�n de agua;;;|".
	             "Verificaci�n de humedad;;;|".
	             "Verificaci�n de polvo excesivo;;;|".
	             "Verificaci�n de plagas(Hormigas, Roedores, etc...);;;";
		$arrays = explode('|',$text);
		$result = "";
		$a = 1;
		foreach ($arrays as $array){
...
<table  width="1050" align="center" class="table2">
		<tr align="center">
			<td width='40%'>VERIFICACI�N DE SISTEMA DE ILUMINACI�N:</td>
			<td width='6%'>No Existe</td>
		...
		<?
		$text =
				 "Verificaci�n operaci�n de focos de Balizamiento en AC Y DC;;;;|".
	             "Verificaci�n de operaci�n de iluminaci�n de salas de energ�a y equipos;;;;|".
	             "Verificaci�n de la correcta distribuci�n de puntos de iluminaci�n;;;;|".
	             "Verificaci�n de operaci�n de iluminaci�n de exteriores, dentro el cerco perimetral de repetidoras;;;;";
		$arrays = explode('|',$text);
		$result = "";
		$a = 1;
		foreach ($arrays as $array){
...
<table  width="1050" align="center" class="table2">
		<tr align="center">
			<td width='40%'>ESTRUCTURA MET�LICA:</td>
			<td width='6%'>No Existe</td>
			<td width='6%'>Correcta</td>
			<td width='6%'>Incorrecta</td>
			<td width='6%'>Observaciones</td>
		...
		$text =
	             ...
	             "Verificaci�n del estado de coaxies,F.O., cableado de bajada.;;;;|".
	             "Verificaci�n de conexion a puesta a tierra.;;;;|".
	             "Control y ajuste de burloner�a.;;;;|".
	             "Control de corrosi�n de torre, portones y partes met�licas.;;;;|".
	             "Control de Cerraduras y Candados.;;;;|".
	             "Control de verticalidad.;;;;|".
	             "Verificar puertas y chapas.;;;;|".
	             "Verificaci�n de techo de equipos.;;;;|".
	             "Verificaci�n de losa de equipos.;;;;";
		$arrays = explode('|',$text);
		$result = "";
		$a = 1;
		foreach ($arrays as $array){
...
<script>
    ...
    cm.readOnly = true; // Se a�ade el atributo
