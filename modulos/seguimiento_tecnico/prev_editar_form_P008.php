...
JOIN formulario_p008 h ON ev.idevento = h.idevento
JOIN p008_formulario f ON h.id = f.id
...
$resultQuery = mysqli_query($conexion, "SELECT * FROM formulario_p008 p WHERE p.id = ".$idformtto);
