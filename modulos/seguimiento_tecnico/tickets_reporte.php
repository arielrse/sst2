...
$estacionentel = isset($_POST["estacionentel"]) ? $_POST["estacionentel"] : '';
$idestacionentel = isset($_POST["idestacionentel"]) ? $_POST["idestacionentel"] : '';



// 
 $cboxregional = $_POST['cboxregional'];
 $cboxmes= isset($_POST['cboxmes']) ? $_POST['cboxmes']: '';
 $cboxano= isset($_POST['cboxano']) ? $_POST['cboxano'] : '';
 $cboxestado= isset($_POST['cboxestado']) ? $_POST['cboxestado'] : '';
 //echo $cboxano;
