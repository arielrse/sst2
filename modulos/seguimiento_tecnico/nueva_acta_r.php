...
require("../../funciones/funciones.php");
	...
	} else echo "<b>Ocurrio un error, revise bien la informaci�n insertada!</b><br>Notifique de este error al administrador del Sistema: ".mysqli_error()."<br><a href='javascript:history.back(1);'>[RETORNAR]</a>";
