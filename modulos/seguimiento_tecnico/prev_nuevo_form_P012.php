...
<TABLE width="900" align="center" class="table2">
	...
	<table  width="1000" align="center" class="table2">
		...
		<?
		$text =	"Verificaci�n del estado de pararrayos.;;;;;;;;;;;|".
		"Revisi�n, limpieza, ajuste, del cable de conexi�n del pararrayos a las mallas de tierra en la base de la torre.;;;;;;;;;;;|".
		"Revisi�n, limpieza, ajuste de  conexiones de cables de torres a la malla de tierra;;;;;;;;;;;";
	...
	<table  width="1000" align="center" class="table2">
		...
		<?
		//$text =	"Verificaci�n del estado de pararrayos.;;;;;;;;;;;|".
		$text =	"Revisi�n , limpieza , ajuste de conexiones de cables, jabalinas mediante las  c�maras de inspecci�n;;;;;;;;;;;|".
		"Revisi�n, limpieza, ajuste de  las conexiones en el distribuidor principal de tierra de la estaci�n;;;;;;;;;;;|".
		"Conexi�n a tierra de equipos;;;;;;;;;;;|".
		"Revisar, limpiar, ajustar las conexiones a tierra de los equipos , racks, grupos generadores, escalerillas, equipos de energ�a, tableros de distribuci�n AC;;;;;;;;;;;|".
		"Protectores de Transientes en Baja Tensi�n;;;;;;;;;;;|".
		"Verificar el estado de  protectores de transientes de baja tensi�n, mediante su indicador visual;;;;;;;;;;;|".
	...
	<br />
		...
		<?
		$text =	"Valor de tierra en la malla ubicada en la base de la torre en Ohms (m�ximo es 10 Ohm)[Ohm];;|Valor de tierra en el distribuidor de tierra de la malla alrededor de la sala de equipos (m�ximo es 10 Ohm)[Ohm];;|Medida de Potencial entre el sistema de tierra y neutro[V];;|Medida Potencial entre el neutro y masa[V];;";
		$arrays = explode('|',$text);
		$result = "";
		$a = 1;
		foreach ($arrays as $array){
