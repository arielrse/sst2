...
$quer= mysqli_query($conexion, "SELECT MAX(id) FROM formulario_p013v");
...
$query= mysqli_query($conexion, "SELECT MAX(id) FROM formulario_p013v");
$row = mysqli_fetch_row($query);
$idm = $idm = trim($row[0]);;

$Hoy = date("Y-m-d H:i:s");
$srr = mysqli_query($conexion, "INSERT INTO p013v_formulario VALUES ('$idm','$ideventos','$responsable','$fechamantenimiento','$Hoy')");


    $res = mysqli_query($conexion, "INSERT INTO formulario_mtto_n VALUES(22,'$idm','P013v','Formulario Mtto. Preventivo Estructura','$tete','$ideventos')");
 }else

  $sql =mysqli_query($conexion, "UPDATE p013v_formulario SET responsable = '$responsable', fechamantenimiento = '$fechamantenimiento' WHERE id = '$idformtto'");
