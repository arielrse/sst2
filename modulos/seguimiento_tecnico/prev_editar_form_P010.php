...
$resultQuery = mysqli_query($conexion, "SELECT * FROM formulario_p010 p WHERE p.id = ".$idformtto);
...
<br />
	...
	<table  width="900" align="center" class="table2">
		...
		if (!isset($p06)){
	$text =	"Medici�n de la temperatura ambiente de salas de equipos (�C);;|Medici�n de la temperatura ambiente de las salas de bater�as / Energia (�C);;";
		}else{
		    $text=$p06;
		}
	...
	<table  width="900" align="center" class="table2">
		...
		$text =	"Limpieza de filtros de los equipos de aire acondicionado y ventiladores;;;;;;;;|".
				"Verificaci�n del funcionamiento de equipos de aire acondicionado;;;;;;;;|".
				"Verificaci�n del funcionamiento de ventiladores AC/DC;;;;;;;;|".
				"Presencia de ruido en el funcionamiento de ventiladores AC/DC;;;;;;;;|".
				"Verificaci�n del funcionamiento de extractores de aire;;;;;;;;";
		$text = $p02;
		$arrays = explode('|',$text);
		$result = "";
		$a = 1;
