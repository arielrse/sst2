...
$f04_1 = $f_verificacion->f04_1 ? "checked" : ""; $f04_2 = $f_verificacion->f04_2 ? "checked" : ""; $f04_3 = $f_verificacion->f04_3;
...
<div class="card">
    <div class="card-body">
        ...
        <table class="table mb-0">
                ...
                <tr>
                    <td>F.2 Verificacion de historico de alarmas</td>
                    <td>
                        <div class="form-check form-check-inline">
                ...
                <tr>
                    <td>F.3 Verificacion fisica integra del gabinete</td>
                    <td>
                        <div class="form-check form-check-inline">
