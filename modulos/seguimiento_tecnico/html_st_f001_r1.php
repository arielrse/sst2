...
$resultado_rev=mysqli_query($conexion, "SELECT cuenta,nombre,observaciones,fecha FROM st_revision_cliente WHERE id_st_trabajos = '".$dato['id_item']."'");
$rev_html = "";
if(mysqli_num_rows($resultado_rev) !=0 ){
	while($dato_rev=mysqli_fetch_array($resultado_rev)){
...
<tr>
<th colspan="2">DESCRIPCION DE LA INTERVENCION</th>
</tr>
<tr>
<td colspan="2" ><?=nl2br($dato['p8'])?></td>
</tr>

<tr>
<th colspan="2">REPUESTOS E INSUMOS UTILIZADOS</th>
</tr>
<tr>
<td colspan="2" ><?=nl2br($dato['p9'])?></td>
</tr>
