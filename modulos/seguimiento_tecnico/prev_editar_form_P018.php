...
$resultQuery = mysqli_query($conexion, "SELECT * FROM formulario_p018 p WHERE p.id = ".$idformtto);
...
<table width="900" align="center" class="table2">
	...
	<tr>
		...
		<td colspan="3" width="75%" class="resaltar"><input name="titulo" type="text" id="titulo" value="<?=$titulo?>" size="70" /></td>
	</tr>
	<tr><td colspan="4"></td></tr>

	<tr>
		<th width="25%">HORA DE INICIO:</th>
		<td width="25%"><input class="Text_left" name="p01" type="text" size="15" value="<?=$p01?>" />&nbsp;00:00</td>
		<th width="25%">HORA DE CONCLUSION:</th>
		<td width="25%"><input class="Text_left" name="p02" type="text" size="15" value="<?=$p02?>" />&nbsp;00:00</td>
	</tr>
...
<table  width="900" align="center" class="table2">
		<tr>
			...
			<td width='70%' align="center"><input class="Text_left" name="p08" type="text" size="80" value="<?=$p08?>" /></td>
		</tr>
		<tr>
			<td width='20%' align="center" class="cafe">TRABAJOS PENDIENTES:</td>
			<td width='70%' align="center"><input class="Text_left" name="p09" type="text" size="80" value="<?=$p09?>" /></td>
		</tr>
</table>
<br />
