...
$resultado=mysqli_query($conexion, "SELECT titulo,imagen FROM st_cronograma_informes_".$pro_key."_archivos WHERE id_st_cronograma_informes_".$pro_key."='".$id_st_cronograma_informes."' AND item='".$item."'");
$dato_arch=mysqli_fetch_array($resultado);
?>
