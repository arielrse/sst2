...
$p013_formulario=mysqli_fetch_array($resultado);
//mysqli_free_result($resultado);

$resultado = mysqli_query($conexion, "SELECT * FROM p013_alarmas where idevento = $idevento ");
$filasalarmas=mysqli_num_rows($resultado);
//mysqli_free_result($resultado);

$resultado = mysqli_query($conexion, "SELECT * FROM p013_verificacionalarmasexternas WHERE idevento= $idevento ");
$filasverificacionalarmasexternas=mysqli_num_rows($resultado);
//mysqli_free_result($resultado);

$resultado = mysqli_query($conexion, "SELECT * FROM p013_observaciones WHERE idevento= $idevento ");
$filasobservaciones=mysqli_num_rows($resultado);
//mysqli_free_result($resultado);
...
$resultado = mysqli_query($conexion, "SELECT * FROM p013_pruebasservicios WHERE idevento= $idevento ");
$filaspruebasservicios=mysqli_num_rows($resultado);
//mysqli_free_result($resultado);
//$p013_pu=mysqli_fetch_array($resultado);

$resultado = mysqli_query($conexion, "SELECT * FROM p013_formularioestaciones WHERE tecnologia='RED 2G GSM' AND idevento= $idevento ");
$filasestacionesgsm=mysqli_num_rows($resultado);
$p013_formularioestacionesGSM=mysqli_fetch_array($resultado);
//mysqli_free_result($resultado);

$resultado = mysqli_query($conexion, "SELECT * FROM p013_formularioestaciones WHERE tecnologia='RED 4G HSPA' AND idevento= $idevento ");
$filasestaciones4g=mysqli_num_rows($resultado);
//mysqli_num_rows($resultado1);
$p013_formularioestaciones4G=mysqli_fetch_array($resultado);

$resultado = mysqli_query($conexion, "SELECT * FROM p013_formularioestaciones WHERE tecnologia='RED LTE' AND idevento= $idevento ");
$filasestacioneslte=mysqli_num_rows($resultado);
$p013_formularioestacionesLTE=mysqli_fetch_array($resultado);
//mysqli_free_result($resultado);

$resultado1 = mysqli_query($conexion, "SELECT * FROM p013_relevamientosceldas,p013_formularioestaciones WHERE
...
$p013_formularioceldasGSM=mysqli_fetch_array($resultado1);

$filasgsm=mysqli_num_rows($resultado1);
//mysqli_free_result($resultado1);

$resultado2 = mysqli_query($conexion, "SELECT * FROM p013_relevamientosceldas,p013_formularioestaciones WHERE
...
$p013_formularioceldas4G=mysqli_fetch_array($resultado2);
$filas4g=mysqli_num_rows($resultado2);
//mysqli_free_result($resultado2);

$resultado3 = mysqli_query($conexion, "SELECT * FROM p013_relevamientosceldas,p013_formularioestaciones WHERE
...
$p013_formularioceldasLTE=mysqli_fetch_array($resultado3);
$filaslte=mysqli_num_rows($resultado3);
