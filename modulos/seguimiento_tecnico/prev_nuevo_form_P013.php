...
<table width="900" align="center" class="table2">
	...
	<tr>
		<th width="25%">Equipo de transmisi�n</th>
		<td width="75%"><input name="p10" type="text" id="p10" size="30" /></td>
	</tr>

	<tr>
		<th width="25%">Energ�a principal</th>
		<td width="75%">
			<select name="p11">
	...
	<tr>
		<th width="25%">Energ�a Respaldo</th>
		<td width="75%">
			<select name="p12">
...
<table  width="900" align="center" class="table2">
	...
	<?
	$text =	"Verificar la instalaci�n del gabinete;;|".
			"Verificar la instalaci�n de la BBU y tarjetas;;|".
...
<table  width="900" align="center" class="table2">
		...
		<?
		$text = "Puerta Abierta;;|".
				"Bater�as en descarga;;|".
				"Corte de energ�a comercial;;|".
				"Inundaci�n;;|".
				"Falla de protecci�n de transcientes;;|".
...
<table  width="900" align="center" class="table2">
		...
		<?
		$text =	"Verificar la instalaci�n de las RRUs;;|".
				"Verificar que cables de energ�a no esten da�ados o rotos;;|".
				"Verificar que cables de aterramiento no esten da�ados o rotos;;|".
				"Verificar el bulcanizado;;|".
				"Verificar etiquetado en Antenas y RRUs;;|".
				"Verificar la instalaci�n de las Antenas;;|".
				"Verificar jumpers;;";
		$arrays = explode('|',$text);
		$result = "";
		$a = 1;
