...
function getPlantilla($conexion, $jsonData, $idgrupo, $idevento){
   ...
   // $uncheck = "<img style='vertical-align:middle' src='../../../img/unchecked.png'>";
    ...
    $cabecera        = getCabecera007($conexion, $jsonData, $idgrupo, $idevento);
                    ...
                    <table class="table mb-0" class="tborder">
                        <tbody>
                           ...
                           <tr>
                                ...
                                <td class="col-20p">'.$d13_01_01.'</td>
                                <td class="col-20p">'.$d13_01_02.'</td>
                                <td class="col-5p no" align="center">2.-</td>
                                <td class="col-20p">'.$d13_02_01.'</td>
                                <td class="col-20p">'.$d13_02_02.'</td>
                           </tr>
                           <tr>
                                <td class="col-5p no" align="center">3.-</td>
                                <td class="col-20p">'.$d13_03_01.'</td>
                                <td class="col-20p">'.$d13_03_02.'</td>
                                <td class="col-5p no" align="center">4.-</td>
                                <td class="col-20p">'.$d13_04_01.'</td>
                                <td class="col-20p">'.$d13_04_02.'</td>
                           </tr>
                           <tr>
                                <td class="col-5p no" align="center">5.-</td>
                                <td class="col-20p">'.$d13_05_01.'</td>
                                <td class="col-20p">'.$d13_05_02.'</td>
                                <td class="col-5p no" align="center">6.-</td>
                                <td class="col-20p">'.$d13_06_01.'</td>
                                <td class="col-20p">'.$d13_06_02.'</td>
                           </tr>
                           <tr>
                                <td class="col-5p no" align="center">7.-</td>
                                <td class="col-20p">'.$d13_07_01.'</td>
                                <td class="col-20p">'.$d13_07_02.'</td>
                                <td class="col-5p no" align="center">8.-</td>
                                <td class="col-20p">'.$d13_08_01.'</td>
                                <td class="col-20p">'.$d13_08_02.'</td>
                           </tr>
                        </tbody>        
                    </table>									                        
                </main>           
