...
if ($totalFilas!=0){
	$href = "$link_modulo?path=prev_editar_form_P019v.php&$params";
	?>
	...
	<script>	
		...
		$(function(){
			...
			////////////////////////////////////		
				...
				nowrap:false,
				url:'data/datagrid_p019v_2.json',				
				...
				idField:'sector',				
				nowrap:false,
				url:'data/datagrid_p019v_3.json',
				...
				idField:'sector',				
				nowrap:false,
				url:'../../paquetes/ajax/rellenar_p019v_6_tdatagrid.php',				
				columns:[[					
			...
			$('#p019v_7').datagrid({
				...
				idField:'sector',				
				nowrap:false,
				url:'../../paquetes/ajax/rellenar_p019v_7_tdatagrid.php',				
				columns:[[					
			...
			$('#p019v_8').datagrid({
				...
				idField:'sector',				
				nowrap:false,
				url:'data/datagrid_p019v_8.json',				
				columns:[[										
					{field:'numero',title:'No.',width:30},					
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		//alert('as');
			...
			jQuery.post("../../paquetes/ajax/insertar_formulario_mtto_n_p019v.php", {
				idevento:idevento
			...
			jQuery.post("../../paquetes/ajax/insertar_p019v_formulario.php", {
				idevento:idevento,
			...
			for(var i=0; i<rowsp019v_2.length; i++){				
				...
				jQuery.post("../../paquetes/ajax/insertar_p019v_2.php", {
						idevento : idevento,
			...
			for(var i=0; i<rowsp019v_3.length; i++){				
				//alert(rowsverificacion[i].idverificacionfisica);
				jQuery.post("../../paquetes/ajax/insertar_p019v_3.php", {
						idevento : idevento,
			...
			for(var i=0; i<rowsp019v_6.length; i++){				
				//alert(rowsverificacion[i].idverificacionfisica);
				jQuery.post("../../paquetes/ajax/insertar_p019v_6.php", {
						idevento : idevento,
			...
			for(var i=0; i<rowsp019v_7.length; i++){				
				//alert(rowsverificacion[i].idverificacionfisica);
				jQuery.post("../../paquetes/ajax/insertar_p019v_7.php", {
						idevento : idevento,
			...
			for(var i=0; i<rowsp019v_8.length; i++){				
				//alert(rowsverificacion[i].idverificacionfisica);
				jQuery.post("../../paquetes/ajax/insertar_p019v_8.php", {
						idevento : idevento,
