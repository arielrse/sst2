...
<tr><td height="20"><textarea name="para" class="resizable" style="width: 596px; height: 50px;" id="para">
<?	if($dato['para'] != ''){
		echo $dato['para'];	
	}else{
...
<tr>
<td height="20"><textarea name="cc" class="resizable" style="width: 596px; height: 50px;" id="cc">
<? 	if($dato['cc'] != ''){
		echo $dato['cc']; 	
	}else{
...
{ 
if(confirm("Esta Guardando esta informaci�n y Pasando al Paso 3 de 3."))
{return true;}
else {return false;}   
