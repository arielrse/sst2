        ...
        <div class="card-body p-3">
            <table class="table mb-0">
                ...
                <tr>
                    ...
                    <td class = "text-center"  colspan="4"><strong>REFERENCIA CÓDIGO RECTIFICADORES - UPS</strong></td>
                </tr>
                <tr>
                    <td>
                        <div class="input-group input-group-sm mb-2">
                    ...
                    <td>
                        <div class="input-group input-group-sm mb-2">
                            <input type="text" class="form-control form-control-sm" name="rec_fuente_a" id="rec_fuente_a" value="<?php echo $rec_fuente_a ?>">
                        </div>
                    </td>
                    <td><strong>UPSA</strong></td>
                    <td>
                        <div class="input-group input-group-sm mb-2">
                            <input type="text" class="form-control form-control-sm" name="ups_fuente_a" id="ups_fuente_a" value="<?php echo $ups_fuente_a ?>">
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <div class="input-group input-group-sm mb-2">
                            <input type="text" class="form-control form-control-sm" name="rec_fuente_b" id="rec_fuente_b" value="<?php echo $rec_fuente_b ?>">
                        </div>
                    </td>
                    <td><strong>UPSB</strong></td>
                    <td>
                        <div class="input-group input-group-sm mb-2">
                            <input type="text" class="form-control form-control-sm" name="ups_fuente_b" id="ups_fuente_b" value="<?php echo $ups_fuente_b ?>">
                        </div>
                    </td>
                </tr>
                <tr>
