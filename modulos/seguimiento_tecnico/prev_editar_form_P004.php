...
JOIN formulario_p004 h ON ev.idevento = h.idevento
JOIN p004_formulario f ON h.id = f.id
...
$resultQuery = mysqli_query($conexion, "SELECT * FROM formulario_p004 p WHERE p.id = ".$idformtto);
