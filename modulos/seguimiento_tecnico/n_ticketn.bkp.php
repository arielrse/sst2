	...
	<tr>
		<td width="50% ">
			...
			<span class="rojo">*</span>Nro de Ticket:
		  	<input name="ticket" type="text" id="ticket" value="<?= !isset($dato) ? $dato['ticket'] : '' ?>" size="20" maxlength="15"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		  	</div>
	...
	<tr>
		<td width="50%">
			<div align="right"><span class="rojo">*</span>Fecha de Inicio:
			    <input name="fecha_inicio_rif" type="text" id="fecha_inicio_rif" size="20"
                       value="<?= !isset($dato) ? $dato['fecha_inicio_rif'] : '' ?>"
                       onclick="displayCalendar(this,'yyyy-mm-dd',this,false)"
                />
		...
		<td width="50%">
			...
			<input name="hora_inicio_rif" type="text" id="hora_inicio_rif" size="15" value="<?= !isset($dato) ? $dato['hora_inicio_rif'] : '' ?>" />
			(hh:mm:ss)
			</div>
		</td>
	</tr>
	<tr>
		<td width="50%">
			<div align="right">Fecha de Fin:
                <input name="fecha_fin_rif" type="text" id="fecha_fin_rif" size="20"
                       value="<?= !isset($dato) ? $dato['fecha_fin_rif'] : '' ?>" onclick="displayCalendar(this,'yyyy-mm-dd',this,false)"
                />
		...
		<td width="50%">
			<div align="right">Hora Fin:
			    <input name="hora_fin_rif" type="text" id="hora_fin_rif" size="15" value="<?= !isset($dato) ? $dato['hora_fin_rif'] : '' ?>" />
			    (hh:mm:ss)
			</div>
		</td>
	</tr>
...
<tr>
		<td width="50%">
			...
			<input name="fecha_not_dim" type="text" id="fecha_not_dim" size="20"
		...
		<td width="50%">
			<div align="left"><span class="rojo">*</span>Hora:
			    <input name="hora_not_dim" type="text" id="hora_not_dim" size="15"
...
<tr>
		<td width="50%">
			<div align="left"><span class="rojo">*</span>Fecha:
			    <input name="fecha_not_sitio" type="text" id="fecha_not_sitio" size="20"
                       value="<?= (!isset($dato) ? $dato['fecha_not_sitio'] : '') ?>" onclick="displayCalendar(this,'yyyy-mm-dd',this,false)"/>
		...
		<td width="50%">
			<div align="left"><span class="rojo">*</span>Hora:
			    <input name="hora_not_sitio" type="text" id="hora_not_sitio" size="15"
...
<td colspan="2" align="center">
    <textarea name="descripcionfalla" class="resizable" style="width: 650px; height: 80px;" id="descripcionfalla">
        <?= (!isset($dato) ? $dato['descripcionfalla'] : '') ?>
    </textarea>
</td>
</tr>
...
<tr>
<td colspan="2" align="center">
<textarea name="observaciones" class="resizable" style="width: 650px; height: 80px;" id="observaciones">
    <?= (!isset($dato) ? $dato['observaciones'] : '') ?>
</textarea>
</td>
</tr>
