...
if (isset($codigo)){
	...
	$consulta = "SELECT cod,inicio,fin,descripcion FROM estadisticas WHERE cod='$codigo'";
...
<tr>
<td>
<form name="amper" method="post" action="../../modulos/seguimiento_tecnico/e_estadistica.php" onSubmit=" return VerifyOne ();">
<input type="hidden" name="filas" value="" />


<table width="100%" class="table2">
<caption><span style="font-size:18px">ELIMINAR CONFIGURACION DE ESTADISTICA</span><br /></caption>
</table>
...
<table width="100%" class="table2">
	...
	<tr>
		...
		<td width="80%">
			<input name="codigo" type="text" id="codigo" value="<?php echo($dato[0]); ?>" size="20" maxlength="15"/>&nbsp;&nbsp;&nbsp;
		</td>
	</tr>
	...
	<tr>
		...
		<td width="80%">
			<input name="fecha_inicio_est" type="text" id="fecha_inicio_est" size="20" value="<?php echo($dato[1]); ?>" onclick="displayCalendar(this,'yyyy-mm-dd',this,false)"/>
	...
	<tr>
		...
		<td width="80%">
			<input name="fecha_fin_est" type="text" id="fecha_fin_est" size="20" value="<?php echo($dato[2]); ?>" onclick="displayCalendar(this,'yyyy-mm-dd',this,false)"/>
	...
	<tr>
		...
		<td width="80%">
			<input name="descripcion" type="text" id="descripcion" value="<?php echo($dato[3]); ?>" size="60" maxlength="100"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		</td>
...
<input name="validar" type="submit" class="large" value="&nbsp;&nbsp;Eliminar&nbsp;&nbsp;" />
</center></td>
</tr>
</tfoot>
</table>
...
{ 
	if(confirm("Esta a punto de eliminar esta información"))
	{	return true;	}
	else {return false;}   
