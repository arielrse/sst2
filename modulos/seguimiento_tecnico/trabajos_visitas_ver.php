...
<caption>DATOS DEL ITEM:</caption>
	...
	<tr><th>Marca:</th><td ><span class="azul"><?=$dato['marca'];?></span> <? if($dato['sn']!='') echo"<br><span class='small'>S/N: ".$dato['sn']."</span>";  ?></td></tr>	
...
?>
 ...
 switch($pro_key){
	...
	default: if($id_user==$id_usuario || $adm==1) { 
		  ...
		  ?>		  </td>
		  <td class="marco" align="center"><?=$img?><? 
...
<a href="<?=$link_modulo_r?>?path=trabajos_visitas_ver_adicionar.php&id_item=<?=$id_item?>" class="enlaceboton"><img src="../../img/adicionar.gif" alt="Adicionar" border="0" align="absmiddle" >Adicionar intervenci&oacute;n a esta estaci�n</a>
</td>
</tr>
</tfoot>	  
<? }?>
...
else { alert("Inserte su observaci�n"); document.amper.observacion.focus();	return false;}
}
}
function activar() {
