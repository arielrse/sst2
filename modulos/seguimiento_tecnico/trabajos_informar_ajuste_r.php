...
$condicion_final="OK+";
 ...
 $dato_p=mysqli_fetch_array(mysqli_query($conexion, "SELECT descripcion FROM parametrica WHERE grupo='st' AND sub_grupo='".$producto."'"));
 $from=$dato_p['descripcion'];
	...
	$d_p = $_POST["d_p"];
	$datox=mysqli_fetch_array(mysqli_query($conexion, "SELECT descripcion FROM parametrica WHERE grupo='mandar_mail' AND sub_grupo='st'"));
...
<strong>Resumen T�cnico:</strong> '.$informe.'<br>
<br>
