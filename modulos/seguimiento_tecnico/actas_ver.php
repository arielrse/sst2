...
$resultado = mysqli_query($conexion, "SELECT a.codigo, a.carpeta, a.descripcion, a.fechainicio, a.fechafin FROM actas a WHERE a.idacta = '$idacta' ");
...
<tr height="16">
	...
	<?php
    $resultado = mysqli_query($conexion, "SELECT d.iddocumentoacta, d.titulo, d.nombredoc FROM documentoacta d WHERE d.idacta = $idacta");
