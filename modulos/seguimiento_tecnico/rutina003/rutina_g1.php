...
<div class="card">
    <div class="card-body">
        ...
        <table class="table mb-0">
            <tbody>
                <tr>
                    <td colspan="5"><h6>G.1	Verificaciones técnicas</h6></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="g1_03_03" value="option1" <?php echo $g1_03_03 ?>>
                ...
                <tr>
                    ...
                    <td>
                        <div class="form-check form-check-inline">
                            ...
                            <label class="form-check-label" for="g1_12_02">Malo</label>
                        </div>
                    </td>
                    <td>
