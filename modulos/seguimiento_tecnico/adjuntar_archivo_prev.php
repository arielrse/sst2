...
$fechaFin 		= $_GET["fin"];
$codigoEstacion = $_GET["codEs"];
$nombreEstacion = $_GET["nomEs"];


$resultado=mysqli_query($conexion, "SELECT sub_grupo FROM parametrica WHERE grupo='tipo_archivo'");
...
<input type="hidden" name="path" value="adjuntar_archivo_prev_r.php" />

<input name="idEvento"       id="idEvento"  type="hidden" value="<?=$idEvento?>">
<input name="anio"           id="anio"      type="hidden" value="<?=$anio?>">
<input name="codCentro"      id="codCentro"      type="hidden" value="<?=$codCentro?>">
<input name="fechaInicio"    id="fechaInicio" type="hidden" value="<?=$fechaInicio?>">
<input name="fechaFin"       id="fechaFin" type="hidden" value="<?=$fechaFin?>">
<input name="codigoEstacion" id="codigoEstacion" type="hidden" value="<?=$codigoEstacion?>">
<input name="nombreEstacion" id="nombreEstacion" type="hidden" value="<?=$nombreEstacion?>">
