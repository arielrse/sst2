    ...
    <div class="card-body">
        ...
        <table class="table mb-0">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="f01_1" value="option1" <?php echo $f01_1 ?>>
                                        <label class="form-check-label" for="f01_1">Si</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="f01_2" value="option2" <?php echo $f01_2 ?>>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="f02_1" value="option1" <?php echo $f02_1 ?>>
                                        <label class="form-check-label" for="f02_1">Si</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="f02_2" value="option2" <?php echo $f02_2 ?>>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="f03_1" value="option1" <?php echo $f03_1 ?>>
                                        <label class="form-check-label" for="f03_1">Si</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="f03_2" value="option2" <?php echo $f03_2 ?>>
