...
$g1_16_01 = $g_desarrollo->g1_16_01 ? "checked" : ""; $g1_16_02 = $g_desarrollo->g1_16_02 ? "checked" : ""; $g1_16_03 = $g_desarrollo->g1_16_03;

$g2_01_01 = $g_desarrollo->g2_01_01 ? "checked" : ""; $g2_01_02 = $g_desarrollo->g2_01_02;
$g2_02_01 = $g_desarrollo->g2_02_01 ? "checked" : ""; $g2_02_02 = $g_desarrollo->g2_02_02;
$g2_03_01 = $g_desarrollo->g2_03_01 ? "checked" : ""; $g2_03_02 = $g_desarrollo->g2_03_02;
$g2_04_01 = $g_desarrollo->g2_04_01 ? "checked" : ""; $g2_04_02 = $g_desarrollo->g2_04_02;
$g2_05_01 = $g_desarrollo->g2_05_01 ? "checked" : ""; $g2_05_02 = $g_desarrollo->g2_05_02;
$g2_06_01 = $g_desarrollo->g2_06_01 ? "checked" : ""; $g2_06_02 = $g_desarrollo->g2_06_02;
$g2_07_01 = $g_desarrollo->g2_07_01 ? "checked" : ""; $g2_07_02 = $g_desarrollo->g2_07_02;

$g3_01_01 = $g_desarrollo->g3_01_01; $g3_01_02 = $g_desarrollo->g3_01_02; $g3_01_03 = $g_desarrollo->g3_01_03; $g3_01_04 = $g_desarrollo->g3_01_04; $g3_01_05 = $g_desarrollo->g3_01_05; $g3_01_06 = $g_desarrollo->g3_01_06;
$g3_02_01 = $g_desarrollo->g3_02_01; $g3_02_02 = $g_desarrollo->g3_02_02; $g3_02_03 = $g_desarrollo->g3_02_03;
$g3_03_01 = $g_desarrollo->g3_03_01;
$g3_04_01 = $g_desarrollo->g3_04_01 ? "checked" : ""; $g3_04_02 = $g_desarrollo->g3_04_02 ? "checked" : "";
$g3_05_01 = $g_desarrollo->g3_05_01 ? "checked" : ""; $g3_05_02 = $g_desarrollo->g3_05_02 ? "checked" : "";
$g3_06_01 = $g_desarrollo->g3_06_01;
    ...
    <div class="card-body">
        ...
        <table class="table">
            ...
            <tr>
                ...
                <td>
                    <div class="form-check form-check-inline">
                        ...
                        <label class="form-check-label" for="">Deteriorado</label>
                    </div>
                </td>
                <td>
                    <input type="text" class="form-control form-control-sm" id="g1_02_03" placeholder="Obs." value="value="<?php echo $g1_02_03 ?>"">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" id="" value="option1" <?php echo $g1_03_01 ?>>
                        <label class="form-check-label" for="">Bueno</label>
                    </div>
                </td>
                <td>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" id="" value="option1" <?php echo $g1_03_02 ?>>
                        <label class="form-check-label" for="">Deteriorado</label>
                    </div>
                </td>
                <td>
            ...
            <tr>
                ...
                <td>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" id="" value="option1" <?php echo $g1_04_01 ?>>
                        <label class="form-check-label" for="">Bueno</label>
                    </div>
                </td>
                <td>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" id="" value="option1" <?php echo $g1_04_02 ?>>
                        <label class="form-check-label" for="">No Cuenta</label>
                    </div>
                </td>
                <td>
            ...
            <tr>
                ...
                <td>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" id="" value="option1" <?php echo $g1_05_01 ?>>
                        <label class="form-check-label" for="">Bueno</label>
                    </div>
                </td>
                <td>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" id="" value="option1" <?php echo $g1_05_02 ?>>
                        <label class="form-check-label" for="">Malo</label>
                    </div>
                </td>
                <td>
            ...
            <tr>
                ...
                <td>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" id="" value="option1" <?php echo $g1_06_01 ?>>
                        <label class="form-check-label" for="">Bueno</label>
                    </div>
                </td>
                <td>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" id="" value="option1" <?php echo $g1_06_02 ?>>
                        <label class="form-check-label" for="">Deteriorado</label>
                    </div>
                </td>
                <td>
            ...
            <tr>
                ...
                <td>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" id="" value="option1" <?php echo $g1_07_01 ?>>
                        <label class="form-check-label" for="">Bueno</label>
                    </div>
                </td>
                <td>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" id="" value="option1" <?php echo $g1_07_02 ?>>
                        <label class="form-check-label" for="">Deteriorado</label>
                    </div>
                </td>
                <td>
            ...
            <tr>
                ...
                <td>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" id="" value="option1" <?php echo $g1_08_01 ?>>
                        <label class="form-check-label" for="">Operativo</label>
                    </div>
                </td>
                <td>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" id="" value="option1" <?php echo $g1_08_02 ?>>
                        <label class="form-check-label" for="">Falla</label>
                    </div>
                </td>
                <td>
            ...
            <tr>
                ...
                <td>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" id="" value="option1" <?php echo $g1_09_01 ?>>
                        <label class="form-check-label" for="">Operativo</label>
                    </div>
                </td>
                <td>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" id="" value="option1" <?php echo $g1_09_02 ?>>
                        <label class="form-check-label" for="">No cuenta</label>
                    </div>
                </td>
                <td>
            ...
            <tr>
                ...
                <td>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" id="" value="option1" <?php echo $g1_10_01 ?>>
                        <label class="form-check-label" for="">Operativo</label>
                    </div>
                </td>
                <td>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" id="" value="option1" <?php echo $g1_10_02 ?>>
                        <label class="form-check-label" for="">No cuenta</label>
                    </div>
                </td>
                <td>
            ...
            <tr>
                ...
                <td>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" id="" value="option1" <?php echo $g1_11_01 ?>>
                        <label class="form-check-label" for="">Operativo</label>
                    </div>
                </td>
                <td>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" id="" value="option1" <?php echo $g1_11_02 ?>>
                        <label class="form-check-label" for="">No cuenta</label>
                    </div>
                </td>
                <td>
            ...
            <tr>
                ...
                <td>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" id="" value="option1" <?php echo $g1_12_01 ?>>
                        <label class="form-check-label" for="">Operativo</label>
                    </div>
                </td>
                <td>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" id="" value="option1" <?php echo $g1_12_02 ?>>
                        <label class="form-check-label" for="">No cuenta</label>
                    </div>
                </td>
                <td>
            ...
            <tr>
                ...
                <td>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" id="" value="option1" <?php echo $g1_13_01 ?>>
                        <label class="form-check-label" for="">Bueno</label>
                    </div>
                </td>
                <td>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" id="" value="option1" <?php echo $g1_13_02 ?>>
                        <label class="form-check-label" for="">No cuenta</label>
                    </div>
                </td>
                <td>
            ...
            <tr>
                ...
                <td>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" id="" value="option1" <?php echo $g1_14_01 ?>>
                        <label class="form-check-label" for="">Cuenta</label>
                    </div>
                </td>
                <td>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" id="" value="option1" <?php echo $g1_14_02 ?>>
                        <label class="form-check-label" for="">No cuenta</label>
                    </div>
                </td>
                <td>
            ...
            <tr>
                ...
                <td>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" id="" value="option1" <?php echo $g1_15_01 ?>>
                        <label class="form-check-label" for="">Existe</label>
                    </div>
                </td>
                <td>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" id="" value="option1" <?php echo $g1_15_02 ?>>
                        <label class="form-check-label" for="">No existe</label>
                    </div>
                </td>
                <td>
            ...
            <tr>
                ...
                <td>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" id="" value="option1" <?php echo $g1_16_01 ?>>
                        <label class="form-check-label" for="">Existe</label>
                    </div>
                </td>
                <td>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" id="" value="option1" <?php echo $g1_16_02 ?>>
                        <label class="form-check-label" for="">No existe</label>
                    </div>
                </td>
                <td>
                    <input type="text" class="form-control form-control-sm" id="" placeholder="Obs." value="value="<?php echo $g1_16_03 ?>"">
                </td>
            </tr>
...
<div class="card">
    <div class="card-body">
        ...
        <div class="input-group input-group-sm mb-2">
            ...
            <input type="text" class="form-control" id="g3_06_01" value="<?php echo $g3_02_01 ?>">

            <span class="input-group-text">L2</span>
            <input type="text" class="form-control" id="g3_06_01" value="<?php echo $g3_02_02 ?>">

            <span class="input-group-text">L3</span>
            <input type="text" class="form-control" id="g3_06_01" value="<?php echo $g3_02_03 ?>">
        </div>
        ...
        <div>
            <h7 class="mb-0">G.3.4 Verificar  distribución Energía AC, para prevenir sobrecargas en térmicos.</h7>
        </div>
        <td>
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="checkbox" id="g3_04_01" value="option1" <?php echo $g3_04_01 ?>>
                <label class="form-check-label" for="g3_04_01">Equilibrado</label>
            </div>
        </td>
        <td></td>
        <td>
            <div class="form-check form-check-inline">
                ...
                <label class="form-check-label" for="g3_04_02">Desequilibrado</label>
            </div>
        </td>
        <td></td>

        <div>
            <h7 class="mb-0">G.3.5 Revisión de calentamiento del cableado en AC por sobrecarga. </h7>
        </div>
        <td>
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="checkbox" id="g3_05_01" value="option1" <?php echo $g3_05_01 ?>>
                <label class="form-check-label" for="g3_05_01">Caliente</label>
            </div>
        </td>
        <td></td>
        <td>
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="checkbox" id="g3_05_02" value="option1" <?php echo $g3_05_02 ?>>
                <label class="form-check-label" for="g3_05_02">Normal</label>
            </div>
        </td>
        <td></td>

        <div>
            <h7 class="mb-0">G.3.6 Medida puesta a tierra Pilastra</h7>
        </div>
        <div class="input-group input-group-sm mb-2">
