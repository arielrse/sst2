...
$dato=mysqli_fetch_array(mysqli_query($conexion, "SELECT producto,id_st_proyecto FROM st_trabajos WHERE id_item='".$id_item."'"));
 $dato_p=mysqli_fetch_array(mysqli_query($conexion, "SELECT descripcion FROM parametrica WHERE grupo='st' AND sub_grupo='".$dato['producto']."'"));
...
$dato_i=mysqli_fetch_array(mysqli_query($conexion, $consulta))
?>
