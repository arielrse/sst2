...
$resultado = mysqli_query($conexion, "SELECT * FROM p019_formulario WHERE idevento = '$idevento' ");
//$totalFilas    =    mysqli_num_rows($resultado);  
$datoP019formulario = mysqli_fetch_array($resultado);

$responsable=$datoP019formulario['responsable'];
$fechamantenimiento=$datoP019formulario['fechamantenimiento'];
$observaciones=$datoP019formulario['observaciones'];
////////////////////////
$resultado = mysqli_query($conexion, "SELECT * FROM p019_relevamientoinfraestructura WHERE idevento = $idevento ");
$filasp019_2=mysqli_num_rows($resultado);
////////////////////////
$resultado = mysqli_query($conexion, "SELECT * FROM p019_transportemicroondas WHERE idevento = $idevento ");
$filasp019_3=mysqli_num_rows($resultado);
////////////////////////
$resultado = mysqli_query($conexion, "SELECT * FROM p019_transportefibra WHERE idevento = $idevento ");
$filasp019_4=mysqli_num_rows($resultado);
////////////////////////
$resultado = mysqli_query($conexion, "SELECT * FROM p019_transportesatelital WHERE idevento = $idevento ");
$filasp019_5=mysqli_num_rows($resultado);
////////////////////////
$resultado = mysqli_query($conexion, "SELECT * FROM p019_mantenimientopreventivo WHERE idevento = $idevento ");
$filasp019_6=mysqli_num_rows($resultado);
////////////////////////
$resultado = mysqli_query($conexion, "SELECT * FROM p019_disptarjetasequipos WHERE idevento = $idevento ");
$filasp019_7=mysqli_num_rows($resultado);
////////////////////////
$resultado = mysqli_query($conexion, "SELECT * FROM p019_relevamientoserviciomovil WHERE idevento = $idevento ");
$filasp019_8=mysqli_num_rows($resultado);
////////////////////////
...
<!--<form name="amper" method="post" action="<?=$link_modulo_r____?>" onSubmit=" return VerifyOne ();">-->
	...
	<input type="hidden" name="filasp019_2" value="<?=$filasp019_2?>" id="filasp019_2" />
	<input type="hidden" name="filasp019_3" value="<?=$filasp019_3?>" id="filasp019_3"/>
	<input type="hidden" name="filasp019_4" value="<?=$filasp019_4?>" id="filasp019_4"/>
	<input type="hidden" name="filasp019_5" value="<?=$filasp019_5?>" id="filasp019_5"/>
	<input type="hidden" name="filasp019_6" value="<?=$filasp019_6?>" id="filasp019_6"/>
	<input type="hidden" name="filasp019_7" value="<?=$filasp019_7?>" id="filasp019_7"/>
	<input type="hidden" name="filasp019_8" value="<?=$filasp019_8?>" id="filasp019_8"/>
	...
	<script>	
		...
		$(function(){
			...
			////////////////////////////////////		
				...
				var filasp019_2=$('#filasp019_2').val();

				if (filasp019_2 >0){
					ruta='../../paquetes/ajax/rellenar_p019_2.php?idevento='+ idevento;
				...
				var filasp019_3=$('#filasp019_3').val();

				if (filasp019_3 >0){
					ruta='../../paquetes/ajax/rellenar_p019_3.php?idevento='+ idevento;
					//ruta='data/datagrid_p019_2.json';
				}else{
					ruta='data/datagrid_p019_3.json';
				}
				...
				var filasp019_4=$('#filasp019_4').val();

				if (filasp019_4 >0){
					ruta='../../paquetes/ajax/rellenar_p019_4.php?idevento='+ idevento;
					//ruta='data/datagrid_p019_2.json';
				}else{
					ruta='data/datagrid_p019_4.json';
				}
				$('#p019_4').datagrid({
				title:'',
				iconCls:'icon-edit',
...
///////////////////////
				//////////////////////////
				var filasp019_5=$('#filasp019_5').val();

				if (filasp019_5 >0){
					ruta='../../paquetes/ajax/rellenar_p019_5.php?idevento='+ idevento;
					//ruta='data/datagrid_p019_2.json';
				}else{
					ruta='data/datagrid_p019_5.json';
				}
				$('#p019_5').datagrid({
				title:'',
				iconCls:'icon-edit',
				...
				////////////////////
				var filasp019_6=$('#filasp019_6').val();

				if (filasp019_6 >0){
					ruta='../../paquetes/ajax/rellenar_p019_6.php?idevento='+ idevento;
					//ruta='data/datagrid_p019_2.json';
				}else{
					ruta='../../paquetes/ajax/rellenar_p019_6_tdatagrid.php';
				}
			...
			/////////////////////////////////////////////////
			var filasp019_7=$('#filasp019_7').val();

				if (filasp019_7 >0){
					ruta='../../paquetes/ajax/rellenar_p019_7.php?idevento='+ idevento;
					//ruta='data/datagrid_p019_2.json';
				}else{
					ruta='../../paquetes/ajax/rellenar_p019_7_tdatagrid.php';
				}
			$('#p019_7').datagrid({
				title:'',
				iconCls:'icon-edit',
			...
			var filasp019_8=$('#filasp019_8').val();

				if (filasp019_8 >0){
					ruta='../../paquetes/ajax/rellenar_p019_8.php?idevento='+ idevento;
					//ruta='data/datagrid_p019_2.json';
				}else{
					ruta='data/datagrid_p019_8.json';
				}	
			$('#p019_8').datagrid({
				title:'',
				iconCls:'icon-edit',
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		//alert('as');
			...
			jQuery.post("../../paquetes/ajax/update_p019_formulario.php", {
				idevento:idevento,
			...
			var filasp019_2=$('#filasp019_2').val();
				...
				if (filasp019_2 >0){
					ruta='../../paquetes/ajax/update_p019_2.php?idevento='+ idevento;
					//ruta='data/datagrid_p019_2.json';
				}else{
					ruta='../../paquetes/ajax/insertar_p019_2.php';
				}
			...
			var filasp019_3=$('#filasp019_3').val();
				...
				if (filasp019_3 >0){
					ruta='../../paquetes/ajax/update_p019_3.php?idevento='+ idevento;
					
					//ruta='data/datagrid_p019_2.json';
				}else{
					ruta='../../paquetes/ajax/insertar_p019_3.php';
				}
			...
			var filasp019_4=$('#filasp019_4').val();
				...
				if (filasp019_4 >0){
					ruta='../../paquetes/ajax/update_p019_4.php?idevento='+ idevento;
					
					//ruta='data/datagrid_p019_2.json';
				}else{
					ruta='../../paquetes/ajax/insertar_p019_4.php';
				}
			...
			var filasp019_5=$('#filasp019_5').val();
				...
				if (filasp019_5 >0){
					ruta='../../paquetes/ajax/update_p019_5.php?idevento='+ idevento;
					
					//ruta='data/datagrid_p019_2.json';
				}else{
					ruta='../../paquetes/ajax/insertar_p019_5.php';
				}
			...
			var filasp019_6=$('#filasp019_6').val();
				...
				if (filasp019_6 >0){
					ruta='../../paquetes/ajax/update_p019_6.php?idevento='+ idevento;
					
					//ruta='data/datagrid_p019_2.json';
				}else{
					ruta='../../paquetes/ajax/insertar_p019_6.php';
				}
			...
			for(var i=0; i<rowsp019_6.length; i++){				
				//alert(rowsverificacion[i].idverificacionfisica);
				jQuery.post("../../paquetes/ajax/update_p019_6.php", {
						idevento : idevento,
			...
			var filasp019_7=$('#filasp019_7').val();
				...
				if (filasp019_7 >0){
					ruta='../../paquetes/ajax/update_p019_7.php?idevento='+ idevento;
					
					//ruta='data/datagrid_p019_2.json';
				}else{
					ruta='../../paquetes/ajax/insertar_p019_7.php';
				}
			...
			var filasp019_8=$('#filasp019_8').val();
				...
				if (filasp019_8 >0){
					ruta='../../paquetes/ajax/update_p019_8.php?idevento='+ idevento;
					
					//ruta='data/datagrid_p019_2.json';
				}else{
					ruta='../../paquetes/ajax/insertar_p019_8.php';
				}
