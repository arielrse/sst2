...
while($dato=mysqli_fetch_array($resultado)){
    ...
    /** **/
    $res_forms = mysqli_query($conexion, "SELECT * FROM formulario_mtto f WHERE f.idevento = $idevento");
    $res_docs = mysqli_query($conexion, "SELECT * FROM documento d WHERE d.idevento = $idevento");

    $num_forms = mysqli_num_rows($res_forms);
    $num_docs = mysqli_num_rows($res_docs);
