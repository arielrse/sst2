...
<table  width="1000" align="center" class="table2">
		<tr align="center">
			...
			<td width='8%' class="verde">Topolog�a Radio MW  1+1, 1+0, 2+0, XPIC, HTBY</td>
			...
			for ($i = 0; $i < sizeof($subarray); $i++) {
				switch($i) {
					case 0:	$result .= "<td>$subarray[$i]</td>";
							...
							break;
					case 1:
					case 2: $result .= "<td align='center'><input type='text' class='Text_left' name='p04$a' size='8'/></td>";
							break;
...
<table width="1000" align="center" class="table2">
	<tr>
		...
		<td><input type='text' class='Text_left' name='p05' size='95'/></td>
	</tr>
</table>
<br />
