...
else echo "<b>Ocurrio un error, revise bien la informaci�n insertada!::</b>".mysqli_error()."<br><a href='javascript:history.back(1);'>[RETORNAR]</a>";
}
if(!isset($_POST['idformtto'])){

$query= mysqli_query($conexion, "SELECT MAX(id) FROM formulario_p003");
$row = mysqli_fetch_row($query);
$idm = $idm = trim($row[0]);;

$Hoy = date("Y-m-d H:i:s");
$srr = mysqli_query($conexion, "INSERT INTO p003_formulario VALUES ('$idm','$ideventos','$responsable','$fechamantenimiento','$p13','$p14','$observaciones','$Hoy')");
 }else

  $sql =mysqli_query($conexion, "UPDATE p003_formulario SET responsable = '$responsable', fechamantenimiento = '$fechamantenimiento', p13 = '$p13', p14 = '$p14', observaciones = '$observaciones'  WHERE id = '$idformtto'");
