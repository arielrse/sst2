...
<? if($priv==1 || $dato['id_usuario']==$id_user) {?>
...
<tr>
<th width="31%" height="20" >Fecha de creaci�n:</th>
<td height="20"><?=$fechatiempo?></td>
</tr>
<tfoot>
<tr>
<td height="20" colspan="2">Responsable Ultima Modificaci�n: <span class="cafe"><?=$dato['resp_mod']?></span><BR />Fecha Ultima Modificaci�n: <span class="cafe"><?=$dato['ult_fecha_mod']?></span></td>
</tr>	
</tfoot>								
</tbody>
</table>
