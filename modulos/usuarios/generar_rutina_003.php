...
$rutina000_titulos = [
    ...
    "C1" =>  "ID Sitio",
    "D1" =>  "Property_id",
    "E1" =>  "Temperatura del ambiente con instrumento",
    "F1" =>  "Temperatura de retorno con instrumento",
    "G1" =>  "Temperatura de inyección con instrumento",
    "H1" =>  "Temperatura de retorno registrado por el equipo",
    "I1" =>  "Temperatura de inyección registrado por el equipo",
    "J1" =>  "Setting de temperatura en el equipo",
    "K1" =>  "Setting de humedad relativa",
    "L1" =>  "Medición de humedad relativa registrado por el equipo",
    "M1" =>  "Medición de alta presión con instrumento",
    "N1" =>  "Medición de baja presión con instrumento",
    "O1" =>  "L1-N",
    "P1" =>  "L2-N",
    "Q1" =>  "L3-N",
    "R1" =>  "L1-L2",
