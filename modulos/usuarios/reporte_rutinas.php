                ...
                <div class="card border-top border-0 border-4 border-primary">
                    <div class="card-body p-5">
                        <div class="card-title d-flex align-items-center">
                            ...
                            <h5 class="mb-0 text-primary">Reporte de rutinas</h5>
                        </div>

                        <form class="row g-3" name="amper" method="post" action="../../modulos/usuarios/generar_rutinas.php">
                            <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                <label for="codeidform" class="form-label">Rutinas</label>
                                <select name="codeidform" id="codeidform" class="form-select" required>
                                    ...
                                    $resultado = mysqli_query($conexion, "SELECT idformulario, codigo, nombre, area FROM formulario WHERE tipo = 'PREVENTIVO' 
                                                            AND codigo in ('001','002','003','004','005',   '007','008','009','010',   '012','013','014')");
                                    while($dato=mysqli_fetch_array($resultado))
