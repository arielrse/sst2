...
class paginado
{
	...
	function query($query)
	{
		...
		{
			$this->error("Ocurri� un error al ejecutar el query <i><b>\"$query_count\"</b></i>. La base dijo : <b>".mysqli_error()."</b>.");
			return false;
		}// Fin If
		//$this->total( result($this->rs(), 0) );
		...
		{
			$this->error("Ocurri� un error al ejecutar el query \"$query\". La base dijo : ".mysqli_error());
			return false;
		}// Fin If
