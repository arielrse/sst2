...
$data = array(
	array('c1'=>'Direcci�n:',				'c2'=>utf8_decode($data_f['p01'])),
	array('c1'=>'Tipo de estaci�n:',		'c2'=>utf8_decode($data_f['p02'])),
...
$pdf->ezText("\n",5);
$data=array(array(	'hx'=>'VERIFICACI�N DE AMBIENTES:','h01'=>'No Existe','h02'=>'Existe','h03'=>'Observaciones'));
$pdf->ezTable($data,'','',
	array('xPos'=>'left',
		'xOrientation'=>'right',
		'showHeadings'=>0,
...
/**---------------------------batman-------------------**/
/** -------------------------------------------------------------------- **/
$data=array(array(	'hx'=>'VERIFICACI�N DE SISTEMA DE ILUMINACI�N:','h01'=>'No Existe','h02'=>'Correcta','h03'=>'Incorrecta','h04'=>'Observaciones'));
$pdf->ezTable($data,'','',
	array('xPos'=>'left',
		'xOrientation'=>'right',
		'showHeadings'=>0,
...
$data=array(array(	'hx'=>'ESTRUCTURA MET�LICA:','h01'=>'No Existe','h02'=>'Correcta','h03'=>'Incorrecta','h04'=>'Observaciones'));
$pdf->ezTable($data,'','',
	array('xPos'=>'left',
		'xOrientation'=>'right',
		'showHeadings'=>0,
