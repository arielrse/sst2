...
$res_p019_2 = mysqli_query($conexion, "SELECT * FROM p019_relevamientoinfraestructura where idevento=".$idevento." ORDER BY numero");

while($datatmp = mysqli_fetch_assoc($res_p019_2)) {
...
$res_p019_3 = mysqli_query($conexion, "SELECT * FROM p019_transportemicroondas where idevento=".$idevento." ORDER BY numero");

while($datatmp = mysqli_fetch_assoc($res_p019_3)) {
...
$res_p019_4 = mysqli_query($conexion, "SELECT * FROM p019_transportefibra where idevento=".$idevento." ORDER BY numero");

while($datatmp = mysqli_fetch_assoc($res_p019_4)) {
...
$res_p019_5 = mysqli_query($conexion, "SELECT * FROM p019_transportesatelital where idevento=".$idevento." order by numero ");





while($datatmp = mysqli_fetch_assoc($res_p019_5)) {
...
$res_p019_6 = mysqli_query($conexion, "SELECT  
...
while($datatmp = mysqli_fetch_assoc($res_p019_6)) {
...
$res_p019_7 = mysqli_query($conexion, "SELECT  p019_tdisptarjetasequipos.orden,
...
while($datatmp = mysqli_fetch_assoc($res_p019_7)) {
...
$res_p019_8 = mysqli_query($conexion, "SELECT * from p019_relevamientoserviciomovil where idevento=".$idevento." 
ORDER BY numero");


while($datatmp = mysqli_fetch_assoc($res_p019_8)) {
