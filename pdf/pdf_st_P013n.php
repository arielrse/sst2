...
$res_form = mysqli_query($conexion, "SELECT *,estacion.codigo AS codigoestacion,centro.nombre as nombrecentro,estacion.nombre AS nombreestacion FROM p013_formulario,estacion,centro WHERE p013_formulario.idestacion=estacion.codigo AND estacion.idcentro=centro.idcentro and idevento = ".$idevento);
...
$pdf->ezText("\n",5);
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
$res_mantenimiento = mysqli_query($conexion, "SELECT  convert(cast(convert(nombreverificacionfisica using latin1) as binary) using utf8) as nombreverificacionfisica,
...
//$data_mantenimiento = mysqli_fetch_array($res_mantenimiento);

//$ixx = 0;

//explotando los datos 
while($datatmp = mysqli_fetch_assoc($res_mantenimiento)) {
...
$pdf->ezText("\n", 5);
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
$res_alarmas = mysqli_query($conexion, "SELECT convert(cast(convert(alarma using latin1) as binary) using UTF8) AS alarma,
...
//explotando los datos 
while($datatmp = mysqli_fetch_assoc($res_alarmas)) {
...
$pdf->ezText("\n", 5);
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
$res_alarmasexternas = mysqli_query($conexion, "SELECT convert(cast(convert(nombreverificaralarmaexterna using latin1) as binary) using UTF8) AS nombreverificaralarmaexterna,
...
//explotando los datos 
while($datatmp = mysqli_fetch_assoc($res_alarmasexternas)) {
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
$res_pruebasservicio = mysqli_query($conexion, "SELECT nombrepruebaservicio,
 numeroa,
 numerob,
 pruebaexitosa,
 fechahora,
...
while($datatmp = mysqli_fetch_assoc($res_pruebasservicio)) {
...
$res_pruebasservicio = mysqli_query($conexion, "SELECT convert(cast(convert(observacion   using latin1) as binary) using UTF8) AS observacion  FROM p013_observaciones WHERE idevento=".$idevento." ORDER BY orden");


$filas=mysqli_num_rows($res_pruebasservicio);
if ($filas>0){
	while($datatmp = mysqli_fetch_assoc($res_pruebasservicio)) {
...
$res_pruebasservicio = mysqli_query($conexion, "SELECT * from p013_relevamientosceldas,p013_formularioestaciones
...
$data_f = mysqli_fetch_array($res_pruebasservicio);
...
$res_pruebasservicio = mysqli_query($conexion, "SELECT convert(cast(convert(sector using latin1) as binary) using UTF8) AS sector,
