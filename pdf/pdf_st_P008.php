...
$res_form = mysqli_query($conexion, "
...
JOIN p008_formulario h 	 ON p.id = h.id
...
$res_grupo = mysqli_query($conexion, "
...
$data_g = mysqli_fetch_array($res_grupo);
...
$pdf->ezText("\n",5);
$data = array(
	array('c1'=>'Tiene paneles solares:',	'c2'=>utf8_decode($data_f['p01'])),
	...
	array('c1'=>'Capacidad (W):',			'c2'=>utf8_decode($data_f['p06'])),
	array('c1'=>'Voltaje (V):',				'c2'=>utf8_decode($data_f['p07'])),
	array('c1'=>'Cantidad:',				'c2'=>utf8_decode($data_f['p08'])),
	array('c1'=>'Marca controlador solar:',	'c2'=>utf8_decode($data_f['p09']))
...
$pdf->ezText("\n",10);
/** -------------------------------------------------------------------- **/
$data=array(array('izq'=>'SISTEMAS DE ENERGIA SOLAR', 'der'=>'CONTROLADOR SOLAR'));
$pdf->ezTable($data,'','',
	array('xPos'=>'left',
		'xOrientation'=>'right',
		'showHeadings'=>0,
		...
		'shadeCol2' => array(0.80,0.80,0.80),
		'cols'=>array(
			'izq'=>array('justification'=>'left','width'=>280),
			'der'=>array('justification'=>'left','width'=>260),
		)
	));
/** -------------------------------------------------------------------- **/
$data = array(
	array('c1'=>'Limpieza de paneles', 						'c2'=>utf8_decode($data_f['p10']), 'c3'=>'Voltaje de entrada al controlador', 	'c4'=>utf8_decode($data_f['p11'])),
	array('c1'=>'Conexiones el�ctricas en el arreglo solar','c2'=>utf8_decode($data_f['p12']), 'c3'=>'Voltaje de salida al controlador', 	'c4'=>utf8_decode($data_f['p13'])),
	array('c1'=>'Voltaje de arreglo de paneles solares', 	'c2'=>utf8_decode($data_f['p14']), 'c3'=>'Corriente de salida del controlador', 	'c4'=>utf8_decode($data_f['p15']))
);
$options = array('xPos'=>'left',
	'xOrientation'=>'right',
	'showHeadings'=>0,
...
$pdf->ezTable($data, '','',$options);
/** -------------------------------------------------------------------- **/
/*array('c1'=>'SISTEMAS DE ENERGIA SOLAR', 				'c2'=>'', 'c3'=>'CONTROLADOR SOLAR', 'c4'=>''),*/
/** -------------------------------------------------------------------- **/
