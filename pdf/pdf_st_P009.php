...
$data = array(
	...
	array('c1'=>'Cantidad de m�dulos:',	'c2'=>utf8_decode($data_f['p08']))
);
...
/** -------------------------------------------------------------------- **/
$data = array(
	array('c1'=>'Corriente DC hacia la carga t�cnica de la estaci�n [A]:',			'c2'=>utf8_decode($data_f['p10'])),
	array('c1'=>'Corriente DC hacia el banco de bater�as de la estaci�n [A]:',		'c2'=>utf8_decode($data_f['p11'])),
	array('c1'=>'Configuraci�n de Parametros:',										'c2'=>utf8_decode($data_f['p12'])),
	array('c1'=>'Verificar y controlar la distribuci�n de AC/DC en tableros:',		'c2'=>utf8_decode($data_f['p13'])),
	array('c1'=>'Revisi�n de sobrecalentamiento del cableado en AC/DC:',			'c2'=>utf8_decode($data_f['p14'])),
