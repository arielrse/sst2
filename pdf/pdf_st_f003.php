...
$pdf->addText(220,716,14,'<b>SUMINISTRO DE DIESEL</b>');
...
$pdf->ezText("\n",12);
$pdf->ezText("<b>3. CONCLUSIONES</b>",12);
$pdf->ezText($dato['conclusiones'],11,array('justification' =>'full'));
$pdf->ezText("\n",12);
$pdf->ezText("<b>4. PERSONAL TECNICO</b>",12);
...
$pdf->addText(220,718,14,'<b>SUMINISTRO DE DIESEL</b>');
...
,array('izq'=>'Cliente: <b>'.$cliente.'</b>','der'=>'Intervenci�n Nro <b>'.$dato['periodo'].' de '.$de.' </b> ')
);
...
,array('izq'=>'Estaci�n: <b>'.$dato_t['ubicacion'].'</b>','der'=>'Departamento: <b>'.$dato_t['departamento'].'</b>')
);
...
/////////// 2:primera fila
$pdf->ezText("\n",5);
$data=array(array('izq'=>'<b>Personal que recibio (Cliente) </b>','der'=>'<b>Personal que se Envio (Dimesat)</b>'));
$pdf->ezTable($data,'','',
array('xPos'=>'right',
'xOrientation'=>'left',
                'showHeadings'=>0,                
...
$p5_4_="";
$p5_5_="";
$p5_1="AEREO O EXPRESO";
$p5_2="CAMION";
$p5_3="LUGAR";
$p5_4="CAMIONETA";
$p5_5="COMPRA RALEO";
switch($dato['p5']){
case 'AEREO O EXPRESO': $p5_1="<b>".$p5_1."</b>";  $p5_1_="<b>X</b>"; break;
case 'CAMION': $p5_2="<b>".$p5_2."</b>"; $p5_2_="<b>X</b>";  break;
case 'LUGAR': $p5_3="<b>".$p5_3."</b>";  $p5_3_="<b>X</b>"; break;
case 'CAMIONETA': $p5_4="<b>".$p5_4."</b>";  $p5_4_="<b>X</b>"; break;
case 'COMPRA RALEO': $p5_5="<b>".$p5_5."</b>";  $p5_5_="<b>X</b>"; break;
}
$p6_1_="";
$p6_2_="";
$p6_3_="";
...
$p6_6="OTROS";
switch($dato['p6']){
case '20 Litros': $p6_1="<b>".$p6_1."</b>"; $p6_1_="<b>X</b>"; break;
case '50 Litros': $p6_2="<b>".$p6_2."</b>"; $p6_2_="<b>X</b>"; break;
case '100 Litros': $p6_3="<b>".$p6_3."</b>"; $p6_3_="<b>X</b>"; break;
case '200 Litros': $p6_4="<b>".$p6_4."</b>"; $p6_4_="<b>X</b>"; break;
case '400 Litros': $p6_5="<b>".$p6_5."</b>"; $p6_5_="<b>X</b>"; break;
}
if(substr($dato['p6'],0,5)=="OTROS") { $p6_6="<b>".$dato['p6']."</b>"; $p6_6_="<b>X</b>"; }

$data=array(array('izq'=>'<b>FORMA DE ENVIO</b>','der'=>'<b>MESURA DE DIESEL</b>'));
$pdf->ezTable($data,'','',
array('xPos'=>'right',
'xOrientation'=>'left',
                'showHeadings'=>0,                
...
array('izq'=>$p5_5,'izq_'=>$p5_5_,'der'=>$p6_5,'der_'=>$p6_5_),
array('izq'=>"",'izq_'=>"",'der'=>$p6_6,'der_'=>$p6_6_)
);
$pdf->ezTable($data,'','',
array('xPos'=>'right',
                'xOrientation'=>'left',                
...
/////////// 4:primera fila
$pdf->ezText("\n",5);
$data=array(array('izq'=>'<b>COMPRA RALEO ESPECIFICAR CUANTO Y QUIEN AUTORIZA</b>'));
$pdf->ezTable($data,'','',
array('xPos'=>'right',
'xOrientation'=>'left',
                'showHeadings'=>0,                
