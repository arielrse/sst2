...
JOIN p004_formulario h 	 ON p.id = h.id
...
$pdf->ezText("\n",5);
$data = array(
	array('c1'=>'Tiene Energ�a comercial:',			'c2'=>utf8_decode($data_f['p01'])),
	array('c1'=>'Empresa distribuidora:',			'c2'=>utf8_decode($data_f['p02'])),
	array('c1'=>'Media / baja tensi�n:',			'c2'=>utf8_decode($data_f['p03'])),
	array('c1'=>'Monof�sico / trif�sico:',			'c2'=>utf8_decode($data_f['p04'])),
	array('c1'=>'Potencia del transformador KVA:',	'c2'=>utf8_decode($data_f['p05'])),
	array('c1'=>'Nro de medidor:',					'c2'=>utf8_decode($data_f['p06']))
);
