...
$pdf->addTextWrap(20,20,740,9,'<b>AMPER S.R.L.</b> | Calle M�xico 1790 | Edif. Mar�a Reyna P.2 Of. 2-C | Telf.: 2486584 � 2486597 | Fax: 2486635 | Casilla 7981  | La Paz, Bolivia | www.amperonline.com','center');
$pdf->restoreState();
$pdf->closeObject();
...
if(strlen($declaracion_proyecto)>150) $pdf->ezText("<b>Declaraci�n del proyecto:</b>\n".$declaracion_proyecto,10);
...
$options = array('xPos'=>'left',
	...
	$resultadox=mysqli_query($conexion, "SELECT producto,marca,caracteristicas,ubicacion,dia,date_format(fecha,'%d/%m/%y') as fecha,condicion_final,date_format(hora_programada,'%H:%i') AS hora_programada,postm_condicion_final,id_usuario FROM v_st_cronograma WHERE id_item='".$id_item."' ORDER BY fecha ASC limit $limit_ini,$limit_fin");
