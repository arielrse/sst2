...
FROM p019v_formulario f,evento e,centro c, estacion est
WHERE
...
$res_p019v_2 = mysqli_query($conexion, "SELECT * FROM p019v_relevamientoinfraestructura where idevento=".$idevento." ORDER BY numero");

while($datatmp = mysqli_fetch_assoc($res_p019v_2)) {
...
///////////////////
$pdf->ezText("\n",4);
$pdf->ezText(utf8_decode("<b>3. Sistema de Transporte Microondas, Fibra Optica </b>"),10);
$pdf->ezText("\n",4);
...
$res_p019v_3 = mysqli_query($conexion, "SELECT * FROM p019v_transportemicroondas where idevento=".$idevento." ORDER BY numero");

while($datatmp = mysqli_fetch_assoc($res_p019v_3)) {
...
'sistema'=>'<b>Sistema de Transporte</b>',
...
$pdf->ezText("\n",4);
$pdf->ezText(utf8_decode("<b>4. mantenimiento Preventivo de Infraestructuras </b>"),10);
$pdf->ezText("\n",4);

$res_p019v_6 = mysqli_query($conexion, "SELECT  
...
while($datatmp = mysqli_fetch_assoc($res_p019v_6)) {
...
$res_p019v_7 = mysqli_query($conexion, "SELECT  p019v_tdisptarjetasequipos.orden,
...
while($datatmp = mysqli_fetch_assoc($res_p019v_7)) {
...
$res_p019v_8 = mysqli_query($conexion, "SELECT * from p019v_relevamientoserviciomovil where idevento=".$idevento." 
ORDER BY numero");


while($datatmp = mysqli_fetch_assoc($res_p019v_8)) {
