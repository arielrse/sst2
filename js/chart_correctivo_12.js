function cargar_grafico_correctivo_12(iddepartamento, fechainicio, fechafin) {
    ...
    $.ajax({
        url: '../../modulos/charts/data_correctivo_12.php',
        type: 'POST',
        data: frmData,
        processData: false,
        contentType: false,
        ...
        success: function (resp) {
            show_grafico_correctivo_12(resp);
        }
    });
}

let myChart12;
function show_grafico_correctivo_12(datos) {
