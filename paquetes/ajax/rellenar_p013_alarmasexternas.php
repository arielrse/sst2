...
$res_form = mysqli_query($conexion, "SELECT * FROM p013_verificacionalarmasexternas,p013_tverificacionalarmasexternas WHERE p013_verificacionalarmasexternas.idverificaralarmaexterna=p013_tverificacionalarmasexternas.idverificaralarmaexterna and idevento=$idevento order by orden");
