...
//if(isset($_POST['idnodo'])){
	...
	$res = mysqli_query($conexion, "SELECT nombreestacion,tecnologia FROM estacionentel WHERE idestacionentel= ".$letters ." and idsitio='".$codes."' and tecnologia='RED 2G GSM'");
	//." and idsitio='".$codes."'"
	...
	while ($ver=mysqli_fetch_array($res)) {
		...
		$cadena=" <script> $('#nombreestacionentelgsm').val('".utf8_encode($ver['nombreestacion'])."'); $('#tecnologiagsm').val('".utf8_encode($ver['tecnologia'])."');</script>";
