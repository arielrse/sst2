...
$res_form = mysqli_query($conexion, "SELECT p013_pruebasservicios.idevento,p013_pruebasservicios.idpruebaservicio,p013_tpruebasservicios.nombrepruebaservicio,
